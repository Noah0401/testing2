...
class SAGPoolPrompt(nn.Module):
    r"""
        ...
        Args:
            ...
            num_clusters (int): The number of clusters. (default: :obj:`1`)
            ratio (float): The proportion of nodes with high scores in the pooling operation. (default: :obj:`0.5`)
            orth_loss (bool): Control whether to use orthogonal loss. (default: :obj:`FALSE`)
            softmax (bool): Control whether to use softmax function. (default: :obj:`FALSE`)
            nonlinearity (str): Nonlinear activation function. (default: :obj:`tanh`)
        """

    def __init__(self, in_channels: int, num_clusters=1, ratio=0.5, orth_loss=False, softmax=False,
                 nonlinearity='tanh'):
    ...
    def add(self, x: Tensor, edge_index: Tensor, batch: Tensor) -> Tensor:
        ...
        Args:
            ...
            edge_index (Tensor): The edge features.
            batch (Tensor): Batch.
        """
...
class DiffPoolPrompt(nn.Module):
    r"""
        ...
        Args:
            in_channels (int): The number of input channels.
            num_clusters (int): The number of clusters. (default: :obj:`10`)
            orth_loss (bool): Control whether to use orthogonal loss. (default: :obj:`FALSE`)
        """
...
def topk(
    ...
    Args:
        ...
        ratio (Optional[Union[float, int]]): The chosen nodes' ratio.
        batch (Tensor): The batch of the graph.
        min_score (Optional[float] = None): If provided, then select the nodes higher than minimum score.
        (default: :obj:`None`)
        tol (float): The tolerance level of scores. (default: :obj:`1e-7`)
    """
