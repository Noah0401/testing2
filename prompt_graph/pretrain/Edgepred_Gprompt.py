...
class Edgepred_Gprompt(PreTrain):
    r"""
        Inherited from PreTrain, forming the Edgepred_Gprompt pre-train method,
        which concentrates on edge tasks.
        ...
        for epoch in range(1, num_epoch + 1):
            ...
            if train_loss_min > train_loss:
                ...
                torch.save(self.gnn.state_dict(),
                           "./Experiment/pre_trained_model/{}/{}.{}.{}.pth".format(self.dataset_name,
                                                                                   'Edgepred_Gprompt', self.gnn_type,
                                                                                   str(self.hid_dim) + 'hidden_dim'))

                print("+++model saved ! {}.{}.{}.{}.pth".format(self.dataset_name, 'Edgepred_Gprompt', self.gnn_type,
                                                                str(self.hid_dim) + 'hidden_dim'))