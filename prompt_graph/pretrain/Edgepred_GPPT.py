...
class Edgepred_GPPT(PreTrain):
    r"""
    Inherited from PreTrain, forming the Edgepred_GPPT pre-train method,
        ...
        for epoch in range(1, num_epoch + 1):
            ...
            if train_loss_min > train_loss:
                ...
                torch.save(self.gnn.state_dict(),
                           "./Experiment/pre_trained_model/{}/{}.{}.{}.pth".format(self.dataset_name, 'Edgepred_GPPT',
                                                                                   self.gnn_type,
                                                                                   str(self.hid_dim) + 'hidden_dim'))

                print("+++model saved ! {}.{}.{}.{}.pth".format(self.dataset_name, 'Edgepred_GPPT', self.gnn_type,
                                                                str(self.hid_dim) + 'hidden_dim'))
