...
def contrastive_loss(x1, x2, temperature=0.1):
    r"""Realize contrastive loss and generate model output and graph data after random perturbation."""
...
def generate_random_model_output(data, model):
    r"""Generate the output of the model after random perturbation"""
...
def generate_corrupted_graph(graph_data, aug='dropE', aug_ratio=0.1):
    r"""Generate the graph data with random disturbance according to different augmentation methods."""
    if aug == 'dropN':
